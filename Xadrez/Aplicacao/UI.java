...
public class UI {
    ...
    public static XadrezPosicao readXadrezPosicao(Scanner input) {
        try {
            ...
            throw new InputMismatchException("Erro 5: Valor invalido para ler.");
        }
    }

    public static void printTabu(PecaXadrez[][] pecas) {
    ...
    public static void printTabu(PecaXadrez[][] pecas, boolean[][] possivelMovimento) {
        for (int i = 0; i < pecas.length; i++) {
            System.out.print((8 - i) + " ");
            for (int j = 0; j < pecas.length; j++) {
